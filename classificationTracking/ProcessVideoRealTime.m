function [ ] = ProcessVideoRealTime( video, trainingHistograms, s, widthOfBins, thresh, numObjsToDetect, vidOutputName, folderNames )
    ...
    function DetectObjectsInBackground
        ...
        if (num ~= 0)
            ...
            if (circles(1,1) ~= 0)
                ...
                if (zerosInARow >= 3) %if 2 zeros in a row, then conclude it's off screen

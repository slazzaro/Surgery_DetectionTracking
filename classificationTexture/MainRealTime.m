function [] = MainRealTime( trainDir, videoPath, vidOutputName, s, thresh )
...
% and try to classify objects in the video
    ...
    tic
    ProcessVideoRealTime( video, trainingHistograms, s, thresh, numObjectsToDetect, vidOutputName, folderNames );
    toc

function [ ] = ProcessVideoRealTime( video, trainingHistograms, s, thresh, numObjsToDetect, vidOutputName, folderNames )
...
%    display(strcat(datestr(now,'HH:MM:SS'),' [INFO] Data directory created at : ',outDir));
    ...
    function DetectObjectsInBackground
        ...
        componentVideo = VideoToScoreVideoSkip( vidAllCopy(:,:,:,batchSize-1:batchSize), trainingHistograms, s, thresh, skip);
